...
import { coachingOf, effectiveTeam, opponentOf, roundName, rosterForMatch, userIsHome } from './career';
...
export function buildSeasonMatch(career: Career, game: ScheduledGame, replays = true) {
  ...
  return makeMatchConfig({
    ...
    homeCoaching: isHome ? coachingOf(career) : undefined,
    awayCoaching: isHome ? undefined : coachingOf(career),
    replays,
  });
}
